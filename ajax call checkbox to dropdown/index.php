...
?>
<input type="radio" id="category-dropdown" value="<?php echo $row['0'];?>">
<?php
}
?>general
</div>
...
while($row = mysqli_fetch_array($result)) {
?>
<input type="radio" id="category" value="<?php echo $row['2'];?>">
<?php
}
?>php
</div>
...
while($row = mysqli_fetch_array($result)) {
?>
<input type="radio" id="cate" value="<?php echo $row['3'];?>">
<?php
}
?>html
</div>
